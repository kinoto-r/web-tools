...
<div class="main-content">
    <div class="card">
        <h1>CSV差分をWord貼り付け用に整形</h1>
        <p class="note">
            「全文CSV」と「差分のみCSV」をアップロードすると、全文CSVの内容に赤字・斜線付きで差分を反映した表を作成します。
        ...
        <form method="post" enctype="multipart/form-data">
            <div class="form-row">
                <label>全文CSV（Excel形式でダウンロードしたもの）</label>
                <input type="file" name="full_csv" accept=".csv" required>
            </div>
            <div class="form-row">
                <label>差分のみCSV（変更部分だけが入ったもの）</label>
